...
+'<p style="margin:6px 0"><b>2.</b> Na página do Mercado Livre, clique no favorito <a href=\''+bookmarklet()+'\' style="color:#087f5b;font-weight:700">Coletar concorrentes</a> (arraste este botão para a barra de favoritos na primeira vez).</p>'
+'<p style="margin:6px 0"><b>3.</b> <button id="refreshcomp" style="padding:8px 14px">Atualizar comparativo</button></p>';
$("refreshcomp").addEventListener("click",async function(){this.disabled=true;this.textContent="Atualizando...";
